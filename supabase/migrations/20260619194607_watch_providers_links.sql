...
values
  ...
  ('fubo', 'Fubo', 'flexoffers', 'rejected', array['US','CA'], array['soccer','football','basketball','hockey','baseball'], 'https://www.fubo.tv/', null, 'Application denied without a reason on 2026-07-13; keep as direct non-affiliate link unless re-approved.', 24, true),
